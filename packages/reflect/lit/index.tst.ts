...
class AllDecoratorsReactiveElement extends ReactiveElement {
...
class AllDecoratorsLitElement extends LitElement {
  @(expect(reflectString()).type.toBeApplicable)
  accessor str: string = "";
  @(expect(reflectString()).type.toBeApplicable)
  set strSetter(value: string) {}
...
test("wrong accessor type", () => {
  class WrongType extends ReactiveElement {
...
test("wrong decorated location", () => {
  class NonReactiveElement {
    @(expect(reflectString()).type.not.toBeApplicable)
    accessor nonReactiveElement: string = "";
  }
  @(expect(reflectString()).type.not.toBeApplicable)
  class WrongLocation extends ReactiveElement {
    @(expect(reflectString()).type.not.toBeApplicable)
    nonAccessor: string = "";
